...
/**
 * Test case for class StadtRevue\SrSmallads\Controller\CategoriesController.
 *
 */
class CategoriesControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \StadtRevue\SrSmallads\Controller\CategoriesController
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = $this->getMock('StadtRevue\\SrSmallads\\Controller\\CategoriesController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function showActionAssignsTheGivenCategoriesToView() {
		$categories = new \StadtRevue\SrSmallads\Domain\Model\Categories();
